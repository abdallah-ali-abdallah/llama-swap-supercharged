...
# loggingEnabled: collect and stream proxy/upstream logs in the web UI
# - optional, default: true
# - when false, logging is disabled entirely and log history is not stored
loggingEnabled: true
...
# metricsDBPath: path to the SQLite database used for persisted dashboard metrics
# - optional, default: llama-swap-metrics.db next to the config file
# - relative paths are resolved from the config file directory
metricsDBPath: llama-swap-metrics.db

# metricsRetentionDays: how many days of dashboard metrics to keep in SQLite
# - optional, default: 30
# - set to 0 to disable automatic cleanup
metricsRetentionDays: 30

# metricsQueryMaxRows: maximum rows returned by a historical dashboard query
# - optional, default: 100000
# - protects the dashboard from loading too many rows at once
metricsQueryMaxRows: 100000

# usageMetricsPersistence: save dashboard usage metrics to SQLite
# - optional, default: true
# - when false, realtime dashboard metrics still work but historical usage is not persisted
...
# captureRedactHeaders: redact sensitive request/response headers before saving captures
# - optional, default: true
# - when false, persisted captures include full request and response headers
captureRedactHeaders: true

# activityFields: controls which fields are saved for future activity rows
# - optional, all fields default to true
# - id and timestamp are always saved
activityFields:
  model: true
  tokens: true
  speeds: true
...
models:
  ...
  "qwen-hidden-metrics":
    ...
    # - optional, default: false
    # - when true, requests to this model will not appear in the Activity event stream or GET /api/metrics
